#include "core_utils/devoptab_common.hpp"
...
namespace GooniesInstaller::devoptab {
namespace {
...
const char* VolumeStr[] {
    GooniesInstaller::devoptab::BIS_MOUNT_ENTRIES[0].volume_name,
    GooniesInstaller::devoptab::BIS_MOUNT_ENTRIES[1].volume_name,
    GooniesInstaller::devoptab::BIS_MOUNT_ENTRIES[2].volume_name,
    GooniesInstaller::devoptab::BIS_MOUNT_ENTRIES[3].volume_name,
};

Result fatfs_read(u8 num, void* dst, u64 offset, u64 size) {
    auto& fat = GooniesInstaller::devoptab::g_fat_storage[num];
