...
SavesView::SavesView(InstalledTitleService* installedService, GameMetadataService* metadata)
    ...
    title->setText(t("Partidas Guardadas", "Save Data", "Jogos salvos"));
    ...
    this->registerAction(t("Buscar", "Search", "Procurar"), brls::BUTTON_Y, [this](brls::View*) {
        ...
        }, t("Buscar partidas", "Search save data", "Pesquisar jogos"), t("Introduce el nombre del juego", "Enter game name", "Digite o nome do jogo"), 100, "", 0);
        return true;
    });
}
