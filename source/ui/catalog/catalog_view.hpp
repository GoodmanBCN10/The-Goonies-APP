...
public:
    CatalogView(DownloadManager* manager, CatalogService* catalog,
        ...
        clearSearch_ = makeChip(t("Limpiar", "Clear", "Limpar"), [this] {
        ...
        openDownloadsBtn->setPaddingLeft(14);
        openDownloadsBtn->setPaddingRight(14);
        openDownloadsBtn->registerClickAction([this](brls::View*) {
            brls::Logger::info("CatalogView: Cola Descargas clicked!");
            if (openDownloads_) {
                brls::Logger::info("CatalogView: Calling openDownloads_()");
                openDownloads_();
                brls::Logger::info("CatalogView: openDownloads_() returned");
            }
            return true;
        });
        header_->addView(openDownloadsBtn);
        ...
        selectVisible->setText(t("Selecc. visible", "Select visible", "Selecione visível"));
