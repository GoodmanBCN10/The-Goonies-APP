...
Result DeleteCommonTicket(const FsRightsId* rightsId) {
    return serviceDispatchIn(&g_esSrv, 3, *rightsId);
}

Result DeletePersonalizedTicket(const FsRightsId* rightsId) {
    return serviceDispatchIn(&g_esSrv, 4, *rightsId);
}
