...
auto install_forwader_internal(frontend::ProgressBox* pbox, OwoConfig& config, NcmStorageId storage_id) -> Result {
...
auto install_forwarder(OwoConfig& config, NcmStorageId storage_id) -> Result {
    App::Push<frontend::ProgressBox>(0, "Installing Forwarder"_i18n, config.name, [config, storage_id](auto pbox) mutable -> Result {
