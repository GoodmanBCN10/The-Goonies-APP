...
namespace GooniesInstaller::frontend::menu::gh {
namespace {

constexpr auto CACHE_PATH = "/switch/GooniesInstaller/cache/github";
...
auto DownloadApp(ProgressBox* pbox, const GhApiAsset& gh_asset, const AssetEntry* entry) -> Result {
    static const fs::FsPath temp_file{"/switch/GooniesInstaller/cache/github/ghdl.temp"};
...
void Menu::Scan() {
    ...
    LoadEntriesFromPath("/config/GooniesInstaller/github/");
    Sort();
    SetIndex(0);
}
