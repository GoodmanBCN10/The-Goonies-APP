...
namespace GooniesInstaller::frontend::menu::game::meta {
namespace {
    ...
    this->SetActions(
        ...
        std::make_pair(Button::X, Action{"Options"_i18n, [this](){
            if (!m_entries.empty()) {
                ...
                items.emplace_back("Export NSP"_i18n);
                items.emplace_back("Export NSZ"_i18n);
                items.emplace_back("Delete"_i18n);

                App::Push<frontend::PopupList>(
                    "Content Options"_i18n, items, [this](auto op_index){
                        if (op_index) {
...
void Menu::Draw(NVGcontext* vg, Theme* theme) {
    ...
    m_list->Draw(vg, theme, m_entries.size(), [this](auto* vg, auto* theme, auto& v, auto i) {
        ...
        gfx::drawTextArgs(vg, x + w - text_xoffset, y + (h / 2.f) - 3, 16.f, NVG_ALIGN_RIGHT | NVG_ALIGN_BOTTOM, theme->GetColour(ThemeEntryID_TEXT_INFO), "%s", core_utils::formatSizeStorage(e.size).c_str());
