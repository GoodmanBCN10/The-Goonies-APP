...
namespace GooniesInstaller::frontend::menu::themezer {
namespace {

// format is /themes/GooniesInstaller/Theme Name by Author/theme_name-type.nxtheme
constexpr fs::FsPath THEME_FOLDER{"/themes/GooniesInstaller/"};
constexpr auto CACHE_PATH = "/switch/GooniesInstaller/cache/themezer";
...
auto InstallTheme(ProgressBox* pbox, const PackListEntry& entry) -> Result {
    static const fs::FsPath zip_out{"/switch/GooniesInstaller/cache/themezer/temp.zip"};
