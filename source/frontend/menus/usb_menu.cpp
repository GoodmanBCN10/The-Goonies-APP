...
namespace GooniesInstaller::frontend::menu::usb {
namespace {
...
Menu::Menu(u32 flags) : MenuBase{"USB"_i18n, flags} {
    ...
    if (m_state != State::Failed) {
        core_utils::CreateThread(&m_thread, thread_func, this, 1024*32);
...
void Menu::Update(Controller* controller, TouchInfo* touch) {
    ...
    if (m_state == State::Connected_StartingTransfer) {
        ...
        App::Push<frontend::ProgressBox>(0, "Installing "_i18n, "", [this](auto pbox) -> Result {
