...
Result InstallFromSource(source::Base* source, const fs::FsPath& path, const ConfigOverride& override = {}, u64* out_freed_bytes = nullptr);
Result InstallFromContainer(container::Base* container, const ConfigOverride& override = {}, u64* out_freed_bytes = nullptr);
Result InstallFromCollections(source::Base* source, const container::Collections& collections, const ConfigOverride& override = {}, u64* out_freed_bytes = nullptr);
