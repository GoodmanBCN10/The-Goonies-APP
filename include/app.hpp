...
#include "frontend/notification.hpp"
#include "owo.hpp"
#include "option.hpp"
#include "fs.hpp"
#include "log.hpp"
#include "core_utils/audio.hpp"
...
public:
    ...
    static void Push(std::unique_ptr<frontend::Widget>&&);

    template<frontend::DerivedFromWidget T, typename... Args>
    ...
    // this is thread safe
    static void Notify(const std::string& text, frontend::NotifEntry::Side side = frontend::NotifEntry::Side::RIGHT);
    static void Notify(frontend::NotifEntry entry);
    static void NotifyPop(frontend::NotifEntry::Side side = frontend::NotifEntry::Side::RIGHT);
    static void NotifyClear(frontend::NotifEntry::Side side = frontend::NotifEntry::Side::RIGHT);
    ...
    static auto Install(frontend::ProgressBox* pbox, OwoConfig& config) -> Result;
    ...
    // void DrawElement(float x, float y, float w, float h, frontend::ThemeEntryID id);
...
// private:
    static constexpr inline auto CONFIG_PATH = "/config/GooniesInstaller/config.ini";
    static constexpr inline auto PLAYLOG_PATH = "/config/GooniesInstaller/playlog.ini";
    ...
    bool m_is_launched_via_GooniesInstaller_forwader{};
    ...
    std::vector<std::unique_ptr<frontend::Widget>> m_widgets;
    u32 m_pop_count{};
    frontend::NotifMananger m_notif_manager{};
    ...
    option::OptionString m_default_music{INI_SECTION, "default_music", "/config/GooniesInstaller/themes/default_music.bfstm"};
