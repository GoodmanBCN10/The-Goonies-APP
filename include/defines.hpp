...
enum class GooniesInstallerResult : Result {
    TransferCancelled,
    StreamBadSeek,
...
#define MAKE_GOONIES_RESULT_ENUM(x) Result_##x =  MAKERESULT(Module_GooniesInstaller, (Result)GooniesInstallerResult::x)

enum : Result {
    MAKE_GOONIES_RESULT_ENUM(TransferCancelled),
    MAKE_GOONIES_RESULT_ENUM(StreamBadSeek),
    MAKE_GOONIES_RESULT_ENUM(FsTooManyEntries),
    MAKE_GOONIES_RESULT_ENUM(FsNewPathTooLarge),
    MAKE_GOONIES_RESULT_ENUM(FsInvalidType),
    MAKE_GOONIES_RESULT_ENUM(FsEmpty),
    MAKE_GOONIES_RESULT_ENUM(FsAlreadyRoot),
    MAKE_GOONIES_RESULT_ENUM(FsNoCurrentPath),
    MAKE_GOONIES_RESULT_ENUM(FsBrokenCurrentPath),
    MAKE_GOONIES_RESULT_ENUM(FsIndexOutOfBounds),
    MAKE_GOONIES_RESULT_ENUM(FsFsNotActive),
    MAKE_GOONIES_RESULT_ENUM(FsNewPathEmpty),
    MAKE_GOONIES_RESULT_ENUM(FsLoadingCancelled),
    MAKE_GOONIES_RESULT_ENUM(FsBrokenRoot),
    MAKE_GOONIES_RESULT_ENUM(FsUnknownStdioError),
    MAKE_GOONIES_RESULT_ENUM(FsStdioFailedToSeek),
    MAKE_GOONIES_RESULT_ENUM(FsStdioFailedToRead),
    MAKE_GOONIES_RESULT_ENUM(FsStdioFailedToWrite),
    MAKE_GOONIES_RESULT_ENUM(FsStdioFailedToOpenFile),
    MAKE_GOONIES_RESULT_ENUM(FsStdioFailedToCreate),
    MAKE_GOONIES_RESULT_ENUM(FsStdioFailedToTruncate),
    MAKE_GOONIES_RESULT_ENUM(FsStdioFailedToFlush),
    MAKE_GOONIES_RESULT_ENUM(FsStdioFailedToCreateDirectory),
    MAKE_GOONIES_RESULT_ENUM(FsStdioFailedToDeleteFile),
    MAKE_GOONIES_RESULT_ENUM(FsStdioFailedToDeleteDirectory),
    MAKE_GOONIES_RESULT_ENUM(FsStdioFailedToOpenDirectory),
    MAKE_GOONIES_RESULT_ENUM(FsStdioFailedToRename),
    MAKE_GOONIES_RESULT_ENUM(FsStdioFailedToStat),
    MAKE_GOONIES_RESULT_ENUM(FsReadOnly),
    MAKE_GOONIES_RESULT_ENUM(FsNotActive),
    MAKE_GOONIES_RESULT_ENUM(FsFailedStdioStat),
    MAKE_GOONIES_RESULT_ENUM(FsFailedStdioOpendir),
    MAKE_GOONIES_RESULT_ENUM(NroBadMagic),
    MAKE_GOONIES_RESULT_ENUM(NroBadSize),
    MAKE_GOONIES_RESULT_ENUM(AppFailedMusicDownload),
    MAKE_GOONIES_RESULT_ENUM(CurlFailedEasyInit),
    MAKE_GOONIES_RESULT_ENUM(DumpFailedNetworkUpload),
    MAKE_GOONIES_RESULT_ENUM(UnzOpen2_64),
    MAKE_GOONIES_RESULT_ENUM(UnzGetGlobalInfo64),
    MAKE_GOONIES_RESULT_ENUM(UnzLocateFile),
    MAKE_GOONIES_RESULT_ENUM(UnzGoToFirstFile),
    MAKE_GOONIES_RESULT_ENUM(UnzGoToNextFile),
    MAKE_GOONIES_RESULT_ENUM(UnzOpenCurrentFile),
    MAKE_GOONIES_RESULT_ENUM(UnzGetCurrentFileInfo64),
    MAKE_GOONIES_RESULT_ENUM(UnzReadCurrentFile),
    MAKE_GOONIES_RESULT_ENUM(ZipOpen2_64),
    MAKE_GOONIES_RESULT_ENUM(ZipOpenNewFileInZip),
    MAKE_GOONIES_RESULT_ENUM(ZipWriteInFileInZip),
    MAKE_GOONIES_RESULT_ENUM(MmzBadLocalHeaderSig),
    MAKE_GOONIES_RESULT_ENUM(MmzBadLocalHeaderRead),
    MAKE_GOONIES_RESULT_ENUM(FileBrowserFailedUpload),
    MAKE_GOONIES_RESULT_ENUM(FileBrowserDirNotDaybreak),
    MAKE_GOONIES_RESULT_ENUM(AppstoreFailedZipDownload),
    MAKE_GOONIES_RESULT_ENUM(AppstoreFailedMd5),
    MAKE_GOONIES_RESULT_ENUM(AppstoreFailedParseManifest),
    MAKE_GOONIES_RESULT_ENUM(GameBadReadForDump),
    MAKE_GOONIES_RESULT_ENUM(GameEmptyMetaEntries),
    MAKE_GOONIES_RESULT_ENUM(GameMultipleKeysFound),
    MAKE_GOONIES_RESULT_ENUM(GameNoNspEntriesBuilt),
    MAKE_GOONIES_RESULT_ENUM(KeyMissingNcaKeyArea),
    MAKE_GOONIES_RESULT_ENUM(KeyMissingTitleKek),
    MAKE_GOONIES_RESULT_ENUM(KeyMissingMasterKey),
    MAKE_GOONIES_RESULT_ENUM(KeyFailedDecyptETicketDeviceKey),
    MAKE_GOONIES_RESULT_ENUM(NcaFailedNcaHeaderHashVerify),
    MAKE_GOONIES_RESULT_ENUM(NcaBadSigKeyGen),
    MAKE_GOONIES_RESULT_ENUM(GcBadReadForDump),
    MAKE_GOONIES_RESULT_ENUM(GcEmptyGamecard),
    MAKE_GOONIES_RESULT_ENUM(GcBadXciMagic),
    MAKE_GOONIES_RESULT_ENUM(GcBadXciRomSize),
    MAKE_GOONIES_RESULT_ENUM(GcFailedToGetSecurityInfo),
    MAKE_GOONIES_RESULT_ENUM(GhdlEmptyAsset),
    MAKE_GOONIES_RESULT_ENUM(GhdlFailedToDownloadAsset),
    MAKE_GOONIES_RESULT_ENUM(GhdlFailedToDownloadAssetJson),
    MAKE_GOONIES_RESULT_ENUM(ThemezerFailedToDownloadThemeMeta),
    MAKE_GOONIES_RESULT_ENUM(ThemezerFailedToDownloadTheme),
    MAKE_GOONIES_RESULT_ENUM(MainFailedToDownloadUpdate),
    MAKE_GOONIES_RESULT_ENUM(UsbDsBadDeviceSpeed),

    MAKE_GOONIES_RESULT_ENUM(NspBadMagic),
    MAKE_GOONIES_RESULT_ENUM(XciBadMagic),
    MAKE_GOONIES_RESULT_ENUM(NcaBadMagic),

    MAKE_GOONIES_RESULT_ENUM(XciSecurePartitionNotFound),
    MAKE_GOONIES_RESULT_ENUM(EsBadTitleKeyType),
    MAKE_GOONIES_RESULT_ENUM(EsPersonalisedTicketDeviceIdMissmatch),
    MAKE_GOONIES_RESULT_ENUM(EsFailedDecryptPersonalisedTicket),
    MAKE_GOONIES_RESULT_ENUM(EsBadDecryptedPersonalisedTicketSize),
    MAKE_GOONIES_RESULT_ENUM(EsBadTicketSize),
    MAKE_GOONIES_RESULT_ENUM(EsInvalidTicketBadRightsId),
    MAKE_GOONIES_RESULT_ENUM(EsInvalidTicketFromatVersion),
    MAKE_GOONIES_RESULT_ENUM(EsInvalidTicketKeyType),
    MAKE_GOONIES_RESULT_ENUM(EsInvalidTicketKeyRevision),

    MAKE_GOONIES_RESULT_ENUM(OwoBadArgs),

    MAKE_GOONIES_RESULT_ENUM(UsbCancelled),
    MAKE_GOONIES_RESULT_ENUM(UsbBadMagic),
    MAKE_GOONIES_RESULT_ENUM(UsbBadVersion),
    MAKE_GOONIES_RESULT_ENUM(UsbBadCount),
    MAKE_GOONIES_RESULT_ENUM(UsbBadBufferAlign),
    MAKE_GOONIES_RESULT_ENUM(UsbBadTransferSize),
    MAKE_GOONIES_RESULT_ENUM(UsbEmptyTransferSize),
    MAKE_GOONIES_RESULT_ENUM(UsbOverflowTransferSize),
    MAKE_GOONIES_RESULT_ENUM(UsbUploadBadMagic),
    MAKE_GOONIES_RESULT_ENUM(UsbUploadExit),
    MAKE_GOONIES_RESULT_ENUM(UsbUploadBadCount),
    MAKE_GOONIES_RESULT_ENUM(UsbUploadBadTransferSize),
    MAKE_GOONIES_RESULT_ENUM(UsbUploadBadTotalSize),
    MAKE_GOONIES_RESULT_ENUM(UsbUploadBadCommand),

    MAKE_GOONIES_RESULT_ENUM(YatiContainerNotFound),
    MAKE_GOONIES_RESULT_ENUM(YatiNcaNotFound),
    MAKE_GOONIES_RESULT_ENUM(YatiInvalidNcaReadSize),
    MAKE_GOONIES_RESULT_ENUM(YatiFirmwareTooLow),
    MAKE_GOONIES_RESULT_ENUM(YatiInvalidNcaSigKeyGen),
    MAKE_GOONIES_RESULT_ENUM(YatiInvalidNcaMagic),
    MAKE_GOONIES_RESULT_ENUM(YatiInvalidNcaSignature0),
    MAKE_GOONIES_RESULT_ENUM(YatiInvalidNcaSignature1),
    MAKE_GOONIES_RESULT_ENUM(YatiInvalidNcaSha256),
    MAKE_GOONIES_RESULT_ENUM(YatiNczSectionNotFound),
    MAKE_GOONIES_RESULT_ENUM(YatiInvalidNczSectionCount),
    MAKE_GOONIES_RESULT_ENUM(YatiNczBlockNotFound),
    MAKE_GOONIES_RESULT_ENUM(YatiInvalidNczBlockVersion),
    MAKE_GOONIES_RESULT_ENUM(YatiInvalidNczBlockType),
    MAKE_GOONIES_RESULT_ENUM(YatiInvalidNczBlockTotal),
    MAKE_GOONIES_RESULT_ENUM(YatiInvalidNczBlockSizeExponent),
    MAKE_GOONIES_RESULT_ENUM(YatiInvalidNczZstdError),
    MAKE_GOONIES_RESULT_ENUM(YatiTicketNotFound),
    MAKE_GOONIES_RESULT_ENUM(YatiInvalidTicketBadRightsId),
    MAKE_GOONIES_RESULT_ENUM(YatiCertNotFound),
    MAKE_GOONIES_RESULT_ENUM(YatiNcmDbCorruptHeader),
    MAKE_GOONIES_RESULT_ENUM(YatiNcmDbCorruptInfos),

    MAKE_GOONIES_RESULT_ENUM(NszFailedCreateCctx),
    MAKE_GOONIES_RESULT_ENUM(NszFailedSetCompressionLevel),
    MAKE_GOONIES_RESULT_ENUM(NszFailedSetThreadCount),
    MAKE_GOONIES_RESULT_ENUM(NszFailedSetLongDistanceMode),
    MAKE_GOONIES_RESULT_ENUM(NszFailedResetCctx),
    MAKE_GOONIES_RESULT_ENUM(NszFailedCompress2),
    MAKE_GOONIES_RESULT_ENUM(NszFailedCompressStream2),
    MAKE_GOONIES_RESULT_ENUM(NszTooManyBlocks),
    MAKE_GOONIES_RESULT_ENUM(NszMissingBlocks),
};

#undef MAKE_GOONIES_RESULT_ENUM
